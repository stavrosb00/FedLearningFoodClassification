...
plot_metrics('outputs/2024-03-30/23-40-23/scaffold_scaffold_dirichlet_balanced_Classes=10_Seed=2024_C=10_fraction0.5_B=32_E=1_R=150.csv') #poly kalo mexri 100

plot_metrics('outputs/2024-04-06/11-33-29/scaffoldv2_scaffold_dirichlet_alpha0.1_balanced_Classes=10_Seed=2024_C=10_fraction0.5_B=32_E=1_R=200.csv')
plot_metrics('outputs/2024-04-06/21-12-08/scaffoldv2_scaffold_dirichlet_alpha0.1_balanced_Classes=10_Seed=2024_C=10_fraction0.5_B=32_E=1_R=200_no_amp.csv') # diaforetiko drift logw tyxaiothta client sampling

plot_metrics('outputs/2024-04-07/15-27-50/scaffold_scaffold_dirichlet_alpha0.5_balanced_Classes=10_Seed=2024_C=10_fraction1_B=32_E=1_R=150.csv')

plot_metrics('outputs/2024-04-08/11-45-34/scaffold_scaffold_dirichlet_alpha0.1_balanced_Classes=10_Seed=2024_C=10_fraction0.5_B=32_E=1_R=150.csv')
