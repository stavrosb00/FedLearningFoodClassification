...
class FedSimSiamStrategy(FedAvg):
    """Implement custom strategy for FedSimSiam with extra options and required aggregation functionality based on FedAvg class."""
    ...
    def __init__(
        ...
        # print(len(initial_parameters))
        # nd_params = parameters_to_ndarrays(initial_parameters)
        # print(f"Init params len: {len(nd_params)}")
        # state_params = ndarrays_to_parameters(nd_params[: self.len_params])
