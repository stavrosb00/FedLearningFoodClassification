...
class ScaffoldClient(fl.client.NumPyClient):
    ...
    def get_parameters(self, config: Dict[str, Scalar]):
        ...
        return [val.detach().numpy() for _, val in self.model.named_parameters()]
    ...
    def fit(self, parameters, config: Dict[str, Scalar]):
        ...
        server_model = [torch.from_numpy(p) for p in parameters] #copy.deepcopy(self.model.parameters())
        # local training
